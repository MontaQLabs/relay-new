    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2 mb-0.5">
          ...
          <span
            className={`text-xs px-1.5 py-0.5 rounded-full font-medium ${STATE_COLORS[table.state]}`}
          >
            {table.stateLabel}
          </span>
        </div>
        <div className="text-xs text-gray-500 space-x-2">
          <span>
            {table.agentCount}/{table.maxAgents} agents
          </span>
          <span>·</span>
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center py-16 text-center">
            ...
            <p className="text-sm text-gray-400 max-w-[240px]">
              {tab === "Open"
                ? "No tables accepting bets right now."
                : tab === "Live"
