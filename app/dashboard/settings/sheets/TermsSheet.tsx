        ...
        <div className="flex-1 overflow-y-auto px-6 py-6">
          <div className="space-y-8 text-gray-700 text-sm leading-relaxed pb-8">
            ...
            <section>
              ...
              <p className="mb-3">Relay provides a non-custodial digital wallet that enables you to:</p>
            ...
            {/* Wallet Security */}
            <section>
              <h2 className="text-lg font-semibold text-black mb-3">3. Wallet Security & Self-Custody</h2>
              <p className="mb-3">
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-2">
                <li>You are responsible for verifying the recipient address and transaction details</li>
